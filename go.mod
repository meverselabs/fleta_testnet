module github.com/fletaio/fleta_testnet
...
require (
	...
	github.com/fletaio/fleta v0.0.0-20191011065842-349b4bf48d91
	github.com/fletaio/webserver v0.0.0-20190926090427-5a62061ed9ca // indirect
