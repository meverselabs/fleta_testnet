...
// StudyAccount is a study account
type StudyAccount struct {
...
func (acc *StudyAccount) Address() common.Address {
	return acc.Address_
}

// Name returns the name of the account
func (acc *StudyAccount) Name() string {
	return acc.Name_
}

// IsFormulator returns it is formulator or not
func (acc *StudyAccount) IsFormulator() bool {
	return true
}

// GeneratorHash returns a generator public hash
func (acc *StudyAccount) GeneratorHash() common.PublicHash {
	return acc.GenHash
}

// IsActivated returns it is activated or not
func (acc *StudyAccount) IsActivated() bool {
	return true
}

// Clone returns the clonend value of it
func (acc *StudyAccount) Clone() types.Account {
	c := &StudyAccount{
...
func (acc *StudyAccount) Validate(loader types.LoaderWrapper, signers []common.PublicHash) error {
	if len(signers) != 1 {
...
func (acc *StudyAccount) MarshalJSON() ([]byte, error) {
